...
class VolunteerAPITest(TestCase):
    ...
    def test_submit_and_get_application(self):
        create = self.client.post('/api/v1/volunteers/applications/', self._application_payload(), format='json')
    ...
    def test_duplicate_application_blocked(self):
        ...
        response = self.client.post('/api/v1/volunteers/applications/', self._application_payload(), format='json')
    ...
    def test_withdraw_only_when_submitted(self):
        self.client.post('/api/v1/volunteers/applications/', self._application_payload(), format='json')
    ...
    def test_cannot_apply_again_after_withdraw(self):
        ...
        retry = self.client.post('/api/v1/volunteers/applications/', self._application_payload(), format='json')
