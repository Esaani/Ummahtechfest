          ...
          <section className="bg-surface-container/80 backdrop-blur-2xl p-8 md:p-12 flex flex-col justify-center relative">
            ...
            <div className="relative z-10">
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                {/* Sign In Button */}
                <button className="w-full bg-primary-fixed text-on-primary-fixed mt-4 py-4 rounded-xl label-md font-bold shadow-[0_0_30px_rgba(163,250,1,0.15)] hover:shadow-[0_0_50px_rgba(163,250,1,0.3)] hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-widest border border-primary-fixed/50 relative overflow-hidden group" type="submit">
